...
with open('Statsbomb/data/competitions.json', encoding = 'UTF-8') as f:
    competitions = json.load(f)
    
#laliga 2019-20 has competition ID 11
competition_id=11

#Load the list of matches for this competition
with open('statsbomb/data/matches/'+str(competition_id)+'/25.json', encoding = 'UTF-8') as f:
    matches = json.load(f)
